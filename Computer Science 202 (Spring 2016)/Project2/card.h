...
class Card {
 ...
 public:
  ...
  bool operator== (const Card& num2) const;

  cPoints getLastCardPoints();
  
  cPoints getFirstPairPoints();

  cPoints getSecondPairPoints();

  cPoints getTripletPoints();
  
  cPoints getQuadrupletPoints();
